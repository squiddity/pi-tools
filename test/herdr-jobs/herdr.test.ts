...
test("distinguishes a missing pane from a malformed response", () => {
  assert.deepEqual(__herdrTest__.parsePaneInspection('{"error":{"code":"pane_not_found","message":"gone"}}', "w:p2"), { kind: "missing", error: "gone" });
