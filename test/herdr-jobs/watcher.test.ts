...
async function testJob() {
  ...
  const metadata: PersistedJobMetadata = { version: 1, id: "abcdefgh", name: "test", command: "echo test", cwd: root, kind: "finite", paneId: "w:p2", placement: "down", createdAt: 1, startedAt: 1, readyPattern: "RÉADY", readyRegex: false, keepPane: true, delivery: "pending", state: "running" };
